...
class HomeProvider with ChangeNotifier{
  ...
  List<ShorcutModel> shorcuts = [
    ...
    ShorcutModel(icon: FontAwesomeIcons.tv, name: 'Categorías', tabpage: CategoriePage(), index: 1),
    ShorcutModel(icon: FontAwesomeIcons.addressCard, name: 'Tiendas', tabpage: UnavaiablePage(), index: 2),
    ShorcutModel(icon: FontAwesomeIcons.lock, name: 'Other', tabpage: UnavaiablePage(), index: 3),
  ];
